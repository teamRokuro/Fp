...
namespace Fp
{
    ...
    public partial class Scripting
    {
        ...
        /// </summary>
        public static readonly IEnumerable<Data> _nothing = Enumerable.Empty<Data>();
        ...
        public static IEnumerable<Data> unsupported(long value)
        {
            warn($"Version {value:X4} unsupported");
            return _nothing;
        }
        ...
        /// <param name="value"></param>
        /// <returns>Empty enumerable.</returns>
        public static IEnumerable<Data> unsupported(ulong value)
        {
            warn($"Version {value:X4} unsupported");
            return _nothing;
        }
        ...
        public static Detector _WAV(this Detector? detector, object? source = null) =>
            ...
            {
                { } when o == __staticDetection && magic("RIFF") && magic("WAVE", 8) => ".wav",
                ReadOnlyMemory<byte> m when m.magic("RIFF") && m.magic("WAVE", 8) => ".wav",
                _ => null
            });
        ...
        public static Detector _BMP(this Detector? detector, object? source = null) =>
            new(detector, source ?? detector?.Source ?? __staticDetection, o => o switch
            {
                { } when o == __staticDetection && magic("BM") && i4l[2] == _length => ".wav",
                ReadOnlyMemory<byte> m when m.magic("BM") && i4l[m, 2] == m.Length => ".bmp",
                _ => null
            });
        ...
        public static Detector __(this Detector? detector, string magicValue, string value, int offset = 0,
            ...
            new(detector, source ?? detector?.Source ?? __staticDetection, o => o switch
            {
                { } when o == __staticDetection && magic(magicValue, offset) => value,
                ReadOnlyMemory<byte> m when m.magic(magicValue, offset) => value,
                _ => null
            });
        ...
        private static readonly object __staticDetection = new();
