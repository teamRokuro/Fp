...
namespace Fp.Structures
{
    ...
    /// </summary>
    public record MultiplicationExpression : BinaryExpression
    {
        /// <summary>
        /// Creates a new instance of <see cref="MultiplicationExpression"/>.
        /// </summary>
        /// <param name="lhs">Left expression.</param>
        /// <param name="rhs">Right expression.</param>
        public MultiplicationExpression(Expression lhs, Expression rhs) : base(lhs, rhs)
        {
        }
...
#pragma warning disable 1591
        ...
        public override object u1f(byte l, float r) => l * r;

        public override object u1d(byte l, double r) => l * r;
        ...
        public override object u2f(ushort l, float r) => l * r;

        public override object u2d(ushort l, double r) => l * r;
        ...
        public override object u4f(uint l, float r) => l * r;

        public override object u4d(uint l, double r) => l * r;
        ...
        public override object u8f(ulong l, float r) => l * r;

        public override object u8d(ulong l, double r) => l * r;
        ...
        public override object s1f(sbyte l, float r) => l * r;

        public override object s1d(sbyte l, double r) => l * r;
        ...
        public override object s2f(short l, float r) => l * r;

        public override object s2d(short l, double r) => l * r;
        ...
        public override object s4f(int l, float r) => l * r;

        public override object s4d(int l, double r) => l * r;
        ...
        public override object s8f(long l, float r) => l * r;

        public override object s8d(long l, double r) => l * r;

        public override object fu1(float l, byte r) => l * r;

        public override object fu2(float l, ushort r) => l * r;

        public override object fu4(float l, uint r) => l * r;

        public override object fu8(float l, ulong r) => l * r;

        public override object fs1(float l, sbyte r) => l * r;

        public override object fs2(float l, short r) => l * r;

        public override object fs4(float l, int r) => l * r;

        public override object fs8(float l, long r) => l * r;

        public override object ff(float l, float r) => l * r;

        public override object fd(float l, double r) => l * r;

        public override object du1(double l, byte r) => l * r;

        public override object du2(double l, ushort r) => l * r;

        public override object du4(double l, uint r) => l * r;

        public override object du8(double l, ulong r) => l * r;

        public override object ds1(double l, sbyte r) => l * r;

        public override object ds2(double l, short r) => l * r;

        public override object ds4(double l, int r) => l * r;

        public override object ds8(double l, long r) => l * r;
...
#pragma warning disable 1591
    ...
    {
        public static Expression operator *(Expression lhs, Expression rhs) => new MultiplicationExpression(lhs, rhs);
    }
#pragma warning disable 1591
}
