...
namespace Fp.Structures
{
    ...
    /// </summary>
    public record BitwiseAndExpression : BinaryExpression
    {
        /// <summary>
        /// Creates a new instance of <see cref="BitwiseAndExpression"/>.
        /// </summary>
...
#pragma warning disable 1591
    ...
    {
        public static Expression operator &(Expression lhs, Expression rhs) => new BitwiseAndExpression(lhs, rhs);
    }
#pragma warning restore 1591
}
